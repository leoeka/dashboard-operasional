            ...
            @if ($proposal && $proposal->ai_reasoning)
                <div
                    ...
                    <div class="flex items-center gap-2 mb-3">
                        ...
                        <div>
                            <h3 class="text-xs font-bold text-blue-800">
                                AI Analysis
                            </h3>
                            <p class="text-[10px] text-blue-500">
                                Analisis berdasarkan request proyek
                            </p>
                        </div>
                    </div>
            ...
            <div class="bg-slate-50
                ...
                <div class="flex gap-3">
                    ...
                    <p class="text-[11px] text-slate-500 leading-relaxed">
                        Proposal ini digunakan sebagai dokumen gambaran awal
                        untuk disampaikan kepada client. Setelah proposal
                        dibuat, proses berikutnya dapat dilanjutkan ke tahap
                        mockup website.
                    </p>
                </div>
            </div>
