    ...
    <x-card padding="p-0">
        ...
        <div class="px-8 pb-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 text-sm mb-8">
                ...
                <div>
                    <p class="text-slate-400 mb-1">No. Telepon</p>
                    <p class="font-medium text-slate-700">{{ $user['phone'] ?? 'Belum diisi' }}</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p class="font-medium text-slate-700">{{ $user['role'] ?? 'Belum diisi' }}</p>
                </div>
            </div>
