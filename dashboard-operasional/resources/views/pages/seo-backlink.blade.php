    ...
    @else
        ...
        @else
            @php
                ...
                // Data untuk kartu Analisis AI & Performa.
            ...
            {{--
            Dipecah jadi tab supaya tiap bagian punya ruang sendiri —
            sebelumnya semua kartu (kebutuhan, analisis AI, PageSpeed)
            ditumpuk di satu halaman panjang, dan makin sesak tiap kali
            ada fitur baru ditambahkan (rencana ke depan: Laporan Traffic
            dari GSC + GA4). Tidak ada logic di dalam tiap kartu yang
            ...
            <div
                ...
                <div x-show="tab === 'ringkasan'">
                    <x-card class="mb-6">
                        ...
                        {{-- ACTIONS (publish artikel — belum dalam scope, tetap placeholder) --}}
                    ...
                    <x-card class="mb-6">
                        ...
                        @else
                            ...
                            <script>
                                // NOTE: sesuaikan 2 nama route di bawah kalau di routes/web.php
                                // Anda beda dari 'pages.projects.seo-backlink.analyze' /
                                // 'pages.projects.seo-backlink.status'.
                ...
                <div x-show="tab === 'performa'">
                    {{-- KARTU PERFORMA WEBSITE (PageSpeed) --}}
                    <x-card class="mb-6">
                        <div class="flex items-center justify-between mb-1">
